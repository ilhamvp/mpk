 ...
 */
$config['site_title']                 = "Monitoring Proyek";       // Site Title, example.com
$config['admin_email']                = "ilhamvannyputrapp@gmail.com"; // Admin Email, admin@example.com
$config['default_group']              = 'unit';           // Default group, use name
...
$config['email_config'] = [
  ...
  'smtp_port' => 587,
  'smtp_user' => 'ilhamvannyputrapp@gmail.com',
