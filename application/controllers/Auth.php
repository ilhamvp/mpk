...
class Auth extends CI_Controller
{
    ...
    $data['namatabel']= 'List Users';
		...
		else
		{
			...
			$this->_render_page('auth' . DIRECTORY_SEPARATOR . 'index', $this->data + $data);
	...
	public function create_user()
	{
		...
		else
		{
			...
			$this->load->view('template/header');
			$this->_render_page('auth' . DIRECTORY_SEPARATOR . 'create_user', $this->data + $data);
			$this->load->view('template/footer');
		}
	}
	/**
	...
	*/
	...
	public function edit_user($id)
	{
		...
		$data['namatabel']= 'Edit Users';
		$data['breadcrumb']= 'Users';
		$this->load->model('M_proyek');
		$data['listunit'] = $this->M_proyek->listunit();
		$data['listuser'] = $this->M_proyek->userbyid($id);
		$data['groupbyid'] = $this->M_proyek->groupbyid($id);
		...
		$this->load->view('template/header');
		$this->_render_page('auth/edit_user', $this->data + $data);
		$this->load->view('template/footer');
