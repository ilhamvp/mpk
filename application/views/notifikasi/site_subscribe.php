...
<div class="starter-template">
            ...
            <div class="contact-form">
                ...
                <form id="ServiceRequest" action="<?php echo base_url(); ?>notifikasi/send_message" method='post'>
					...
					<div class="form-group">
                        ...
                        <input type="text" name="img" class="form-control" placeholder="Add Your img" value="" >
                    </div>
